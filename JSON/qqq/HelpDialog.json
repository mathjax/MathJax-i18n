{
  ...
  "ShowMath": "First item of the the 'Math Menu' paragraph. Stars around 'Show Math As' is the Markdown syntax to put it in emphasis.",
  "Settings": "Second item of the the 'Math Menu' paragraph. Stars around 'Settings' is the Markdown syntax to put it in emphasis.",
  "Language": "Third item of the the 'Math Menu' paragraph. Stars around 'Language' is the Markdown syntax to put it in emphasis.",
  "Zoom": "Fourth paragraph of the MathJax Help dialog. Stars around 'Math Zoom' is the Markdown syntax to put it in emphasis.",
  "Accessibilty": "Fifth paragraph of the MathJax Help dialog. Stars around 'Accessibilty' is the Markdown syntax to put it in emphasis.",
